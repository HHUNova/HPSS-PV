...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int ID = 0; ID < X; ID++) {
            ...
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//CVaR"+String.format("%.2f",alpha)+".xlsx");
            CVaR = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//ReCVaR"+String.format("%.2f",alpha)+".xlsx");
            ReCVaR = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//z" + (ID + 1) + ".xlsx");
            z[ID] = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//v" + (ID + 1) + ".xlsx");
            v[ID] = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//q" + (ID + 1) + ".xlsx");
            q[ID] = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//zTail" + (ID + 1) + ".xlsx");
            zTail[ID] = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//input" + (ID + 1) + ".xlsx");
            inputAll[ID] = arrayTrans.function2(set);
            inputQAll[ID] = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//PVPredict" + (ID + 1) + ".xlsx");
            NPVPredictAll[ID] = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//PVMeasure" + (ID + 1) + ".xlsx");
            NPVMeasureAll[ID] = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//t.xlsx");
            t = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//hour.xlsx");
            hour = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//Priceda.xlsx");
            pricedaAll = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//Pricert.xlsx");
            pricertAll = arrayTrans.function2(set);
            set = readExcel.function1("C://Users//Administrator//Desktop//HPSS-PV//dataset//z0Plan" + (ID + 1) + ".xlsx");
